...
start_script() {
  ...
  echo -e "${BOLD}${BLUE}[+]                  © HAMZY OFFICIAL                [+]${NC}"
  echo -e "${BOLD}${BLUE}[+]                                                 [+]${NC}"
  echo -e "${BOLD}${BLUE}[+] =============================================== [+]${NC}"
  echo -e ""
...
check_token() {
  echo -e "                                                       "
  echo -e "${BOLD}${BLUE}[+] =============================================== [+]${NC}"
  echo -e "${BOLD}${BLUE}[+]              HAMZY OFFICIAL LICENSE              [+]${NC}"
  echo -e "${BOLD}${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
...
install_theme() {
  ...
  while true; do
    ...
    case "$SELECT_THEME" in
      1) THEME_NAME="Stellar"; THEME_URL="https://github.com/LetHamzy/themeinstaller/raw/main/theme/stellar.zip"; break;;
      2) THEME_NAME="Billing"; THEME_URL="https://github.com/LetHamzy/themeinstaller/raw/main/theme/billing.zip"; break;;
      3) THEME_NAME="Enigma"; THEME_URL="https://github.com/LetHamzy/themeinstaller/raw/main/theme/enigma.zip"; break;;
      4) THEME_NAME="Elysium"; THEME_URL="https://github.com/LetHamzy/themeinstaller/raw/main/theme/elysium.zip"; break;;
      5) THEME_NAME="Frostcore"; THEME_URL="https://github.com/LetHamzy/themeinstaller/raw/main/theme/frostcore.zip"; break;;
      6) THEME_NAME="Nightcore"; THEME_URL="https://github.com/LetHamzy/themeinstaller/raw/main/theme/nightcore.zip"; break;;
      7) THEME_NAME="IceMinecraft"; THEME_URL="https://github.com/LetHamzy/themeinstaller/raw/main/theme/ice.zip"; break;;
      8) THEME_NAME="Noobe"; THEME_URL="https://github.com/LetHamzy/themeinstaller/raw/main/theme/noobe.zip"; break;;
      9) install_timpa "https://github.com/reviactyl/panel/releases/latest/download/panel.tar.gz" "Reviactyl"; return;;
      10) THEME_NAME="Nebula"; THEME_URL="https://github.com/LetHamzy/themeinstaller/raw/main/theme/nebula.zip"; break;;
      11) THEME_NAME="Recolor"; THEME_URL="https://github.com/LetHamzy/themeinstaller/raw/main/theme/recolor.zip"; break;;
      12) THEME_NAME="NavySeals"; THEME_URL="https://github.com/LetHamzy/themeinstaller/raw/main/theme/navyseals.zip"; break;;
